...
3. Цикл игры повторяется пока кол-во раундов или кол-во очков меньше 3:
  ...
  обнуляем кол-во очков, делаем инкремент счетчика раундов и переходим к следующему вопросу
  // (пункт 3.1)
...
import askNameAndHellow from './cli.js'; // Подключаем модуль, в котором есть ф-я приветствия
...
export default (gameCondition, questions, rightAnswers) => {
  ...
  while (currentRound < maxRounds && userScore < scoreForWin) {
    ...
    // 3.3 Сравниваем ответ пользователя с правильным ответом
    // 3.4 В случае правильного ответа прибавляем очко и переходим к следующему вопросу
    // (пункт 3.1)
