...
1. Генерируем данные для основного модуля index.js:
  ...
  generateRandNumber
  1.3 Массив правильных ответов: 'yes', если число четное; 'no', если число нечетное.
  Используем для этого остаток от деления на 2
...
export default () => {
  ...
  // Для генерации используется цикл for и ф-и generateRandNumber, isEven, данные записываются
  // в стек
  for (let i = 0; i < 9; i += 1) {
